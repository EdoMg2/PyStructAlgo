#Practica 2.2 BST-corregido
#Sube tu arbol binario completo hasta el metodo de borrado.
...
if __name__ == '__main__':
    print('**ELIMINACION DEL ARBOL**\n')
    Pino = Binary_tri() #Se crea el arbol binario pino
    datos = [18, 8, 6, 9, 22, 21, 20,43, 44, 45] #Arreglo 'datos' con los valores que se agregaran al artbol pino
    ...
    # ULTIMA MODIFICACION 14 DE OCTUBRE DEL 2021 A LAS 18:10 PM, TIJUANA BAJA CALIFORNIA