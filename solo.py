...
class Contador
    ...
    def imprimir (self):
        print('El numero de intentos ha sido: ', self.numero)
...
def mergeSort(A, l, r, ): #contador es necesario para la impresion del numero de modificaciones
    if l < r:
        m = l + (r - l) // 2

        mergeSort(A, l, m)
        mergeSort(A, m + 1, r)
        cuenta= merge(A, l, m, r)
...
mergeSort(arr, 0, n - 1)
print("\nArray ordenado es:",arr)
print('el numero de veces que se modifico es:', mergeSort(arr, 0, n - 1))
