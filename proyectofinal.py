...
class Arbol_B:  # Clase de arboles B
    ...
    def Merge_assist(self, node, brother, papa, position_as_child, direction_brother):      #Metodo para asistir en la union de nodos
        ...
        if direction_brother == 'right':            #Si la direccion con la que se envio es derecha
            ...
            self.Delete_key(papa, position_as_child)            #Se borrara la clave del padre
        ...
        if self.keys_checker(papa) == True and self.root != papa: #Si hay error en el nodo papa
            ...
            if right_u != [None]:               #Si hay tio derecho
                ...
                if right_u.n > self.t:          #Si los numero de claves del tio erecho es mayor al minimo
                ...
                if left_u.n > self.t:           #Si tiene claves de sobra
...
if __name__ == '__main__':
    ...
    Pino = Arbol_B(2)       #Se crea el arbol y se llama el metodo para armar la raiz
    ...
    # ULTIMA MODIFICACION 26 DE NOVIEMBRE DEL 2021 A LAS 21:10 PM, TIJUANA BAJA CALIFORNIA